...
class _HomeScreen4State extends State<HomeScreen4> {
  ...
  initGame() {
    ...
    items = [
      ...
      ItemModel(value: 'milk', name: '🐄', img: 'assets/img/FoodetS/fromage.png'),
      ItemModel(value: 'crt', name: '🌾', img: 'assets/img/FoodetS/baguette.png'),
      ItemModel(value: 'orange', name: '🌳', img: 'assets/img/FoodetS/apple.png'),
      ItemModel(value: 'orange', name: '🌳', img: 'assets/img/FoodetS/orange.png'),
      ItemModel(value: 'potato', name: '🥔', img: 'assets/img/FoodetS/french-fires.png'),
      ItemModel(value: 'orange', name: '🌳', img: 'assets/img/FoodetS/grapefruit.png'),
